      ...
      <div className="max-w-md w-full space-y-8 bg-white p-10 rounded-2xl shadow-xl transition-all">
        <div>
          ...
          <p className="mt-2 text-center text-sm text-gray-600">
            ...
            <a href="/auth/signin" className="font-semibold text-blue-600 hover:text-blue-500 transition-colors">
              Sign in
            </a>
          </p>
        </div>
        ...
        <form className="mt-8 space-y-5" onSubmit={handleSubmit}>
          ...
          <div>
            <label htmlFor="role" className="text-sm font-medium text-gray-700 block mb-1">I am a</label>
            <select
              id="role" name="role" required
              className="appearance-none block w-full px-3 py-2.5 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent sm:text-sm bg-white"
              value={formData.role}
              onChange={handleChange}
            >
          ...
          <div className="pt-2">
            <button
              ...
              className={`group relative w-full flex justify-center py-2.5 px-4 border border-transparent text-sm font-semibold rounded-lg text-white ${
                loading || successMessage ? "bg-blue-400 cursor-wait" : "bg-blue-600 hover:bg-blue-700 hover:shadow-md"
